        ...
        <nav class="mt-2 space-y-0.5 px-2">
            ...
            <a href="<?php BASE_URL?>/pages/user/dashboardUser.php" 
               class="flex items-center gap-2 
                ...
                <div class="absolute right-2 w-1 h-1 bg-[#2563EB] rounded-full opacity-0 group-hover/nav:opacity-100 transition-opacity"></div>
            </a>
...
<aside id="mobileSidebar"
    ...
    <div>
        ...
        <nav class="mt-2 space-y-0.5 px-2">
            ...
            <a href="<?php BASE_URL ?>/pages/user/schedule/listJadwal.php" 
               class="flex items-center gap-2 p-2.5 rounded-md bg-blue-50 text-[#2563EB]">
                <svg class="w-4 h-4 text-[#2563EB]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
                <span class="text-sm font-semibold">Jadwal</span>
                <div class="ml-auto w-1.5 h-1.5 bg-[#2563EB] rounded-full animate-pulse"></div>
            </a>
