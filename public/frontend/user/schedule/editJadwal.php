...
<body class="bg-gradient-to-br from-gray-50 to-blue-50/30">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 mt-2">
                            <span class="text-sm text-gray-600">ID: <span class="font-medium text-blue-600">#<?= $data['id_schedule'] ?></span></span>
                            <span class="hidden md:inline text-gray-400">•</span>
                            <span class="hidden md:inline text-sm text-gray-500">Terakhir diubah: <?= date('d/m/Y', strtotime($data['updated_at'] ?? 'now')) ?></span>
                        </div>
                    </div>
                </div>
            ...
            <?php if (!empty($error)): ?>
                <div class="max-w-4xl mx-auto mb-6 p-4 bg-gradient-to-r from-red-50 to-orange-50 border border-red-200/50 text-red-700 rounded-xl backdrop-blur-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="font-medium">Gagal memperbarui jadwal</p>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="tipe_event" 
                                            ...
                                            <?php foreach ($eventConfig as $key => $config): ?>
                                                <option value="<?= $key ?>" 
                                                        class="py-2"
                                                        <?= $data['tipe_event'] == $key ? 'selected' : '' ?>>
                                                    <?= $config['label'] ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100/50">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div class="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <button type="submit" 
                                            class="px-8 py-3.5 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-xl hover:from-yellow-600 hover:to-orange-600 
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .grid-cols-2, .md\:grid-cols-2, .md\:grid-cols-3 {
                grid-template-columns: 1fr;
            }
        }
